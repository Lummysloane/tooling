...
```
git add --all # If you are satisfied with your changes and willing to push everything. Otherwise, select only the files to add. my first
```
...
Hello, learning Devops.

checking Jenkins update
